...
<body>
	<form method="post" action="${_contextPath}systemConfig/edit.do"
			...
			<table width="100%" style="border: 0px;"
				...
				<tr>
					...
					<td align="left"><input type="text" class="input-sm"
						value="${dataObj.name }" name="name" id="name"
				...
				<tr>
					...
					<td align="left"><input type="text" class="input-sm"
						value="${dataObj.configKey }" name="configKey" id="configKey"
						data-rule="required" style="width: 300px;"></td>
				</tr>
				...
				<tr>
					...
					<td align="left"><input type="text" class="input-sm"
						value="${dataObj.configValue }" name="configValue"
						id="configValue" data-rule="required" style="width: 300px;"></td>
				</tr>
