...
<body>
	<form method="post" action="${_contextPath}user/edit.do"
		...
		<div class="table-responsive">
			<table width="100%" style="border: 0px;"
				...
				<tr>
					...
					<td align="left"><input type="text" class="input-sm" value="${dataObj.username }"
				...
				<tr>
					...
					<td align="left"><input type="text" class="input-sm"  value="${dataObj.fullname }"
				...
				<tr>
					...
					<td align="left"><input type="text" class="input-sm"  value="${dataObj.email }"
				...
				<tr>
					...
					<td align="left"><input type="text" class="input-sm"  value="${dataObj.mobile }"
